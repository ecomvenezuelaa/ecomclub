  ...
  if (!expanded) {
    return (
      <button
        ...
        className="w-full flex items-center justify-center gap-2 py-3.5 rounded-2xl border-2 border-dashed border-orange-200 text-orange-700 font-bold text-sm hover:bg-orange-50 transition-colors"
      >
